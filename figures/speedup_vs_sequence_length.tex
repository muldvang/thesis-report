\tikzsetnextfilename{speedup_vs_sequence_length}
\begin{tikzpicture}[trim axis left,trim axis right]
  \begin{axis}[
    ...
    table[x=T, y=zipHMMlib_total_ratio, y error=zipHMMlib_total_ratio_std]
    {plot_data/viterbi_sequence_transformed.data};

    \addplot[only marks, color=colorbrewer4, error bars, y dir=both, y explicit]
    table[x=T, y=zipHMMlib_path_total_ratio, y error=zipHMMlib_path_total_ratio_std]
    {plot_data/viterbi_sequence_transformed.data};

    \addplot[only marks, color=colorbrewer5, error bars, y dir=both, y explicit]
    table[x=T, y=zipHMMlib_path_memory_total_ratio, y error=zipHMMlib_path_memory_total_ratio_std]
    {plot_data/viterbi_sequence_transformed.data};
