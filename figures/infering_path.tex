...
\begin{tikzpicture}[
  ...
  \tikzstyle{vector} = [minimum width=4mm, inner sep=0mm, minimum height=7mm];
  ...
  \node (s10) at (0, -3) {$v_{10}$};
  \node       at (3, -3) {$v_7$};
  \node       at (6, -3) {$v_4$};
  \node       at (7, -3) {$v_3$};
  \node       at (9, -3) {$v_1$};

  \node[rotate=320, anchor=west, xshift=-\widthof{$v_2$}] at (8, -3) {$v_2 = R_2(v_1, v_3)$};
  \node[rotate=320, anchor=west, xshift=-\widthof{$v_5$}] at (5, -3) {$v_5 = R_3(v_4, v_7)$};
  \node[rotate=320, anchor=west, xshift=-\widthof{$v_6$}] at (4, -3) {$v_6 = R_2(v_5, v_7)$};
  \node[rotate=320, anchor=west, xshift=-\widthof{$v_8$}] at (2, -3) {$v_8 = R_3(v_7, v_{10})$};
  \node[rotate=320, anchor=west, xshift=-\widthof{$v_9$}] at (1, -3) {$v_9 = R_2(v_8, v_{10})$};

  \node[left of=s'5] {$V_{1:T'}'$};
  \node[left of=s10] {$V_{1:T}$};
\end{tikzpicture}
%%% Local Variables:
%%% mode: latex
%%% TeX-master: "../master"
