...
\begin{tikzpicture}[trim axis left,trim axis right]
  \begin{axis}[
    ...
    table[x=N, y=zipHMMlib_path_backtrack_time/N^2, y error=zipHMMlib_path_backtrack_time/N^2_std]
    {plot_data/viterbi_model_transformed.data};

    \addplot[only marks, color=colorbrewer2, error bars, y dir=both, y explicit]
    table[x=N, y=zipHMMlib_path_memory_backtrack_time/N^2, y error=zipHMMlib_path_memory_backtrack_time/N^2_std]
    {plot_data/viterbi_model_transformed.data};
