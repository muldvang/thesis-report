...
forward-backward and the Viterbi algorithms are the reformulated into series of
...
substrings the multiplications can be avoided. A single experiment have been
performed on some DNA sequences showing a speedup of the Viterbi algorithm when
