  ...
  \onslide<+->{
    \begin{center}
      \begin{tabular}{rcccccccccc}
        Observation $Y_{1:T}$           & \Sun & \Sun & \Sun & \Cloud & \Cloud & \Rain & \Rain & \Sun & \Sun & \Sun \\
        \onslide<+-> Decoding $X_{1:T}$ & H    & H    & H    & H      & L      & L     & L     & L    & H    & H    \\
      \end{tabular}
    \end{center}}
\end{frame}
...
\begin{frame}
  ...
  \onslide<+->
  This can be solved using dynamic programming using
  \begin{equation*}
    \begin{aligned}
